...
LINK -subsystem:console -dll -implib:..\lib\%TARGET%\lua53.lib -out:..\dist\%TARGET%\lua53.dll *.obj lua_dll.res
LINK -out:..\dist\%TARGET%\lua53.exe lua.obj lua.res ..\lib\%TARGET%\lua53.lib
...
LINK -out:..\dist\%TARGET%\luac53.exe luac.o lua_simple.res ..\lib\%TARGET%\lua53-static.lib
